$(document).ready(function(){
	var scrolling=true;
	var originX;
	slider1 = $('.bxslider1').bxSlider({pager:false,infiniteLoop: false});
	slider2 = $('.bxslider2').bxSlider({controls:false,pager:false,infiniteLoop: false});
	slider3 = $('.bxslider3').bxSlider({controls:false,pager:false,infiniteLoop: false});
	var currentSlide;
	//FULLPAGEJS
	$('#fullpage').fullpage({
		touchSensitivity: 15,
		...
		afterLoad: function( anchorLink, index, slideAnchor, slideIndex){
				if(index==1){
					currentSlide=1;
					$("#indicatorActive").animate({width:"20%"});
					$(".question").draggable({ 
						containment: "parent",  
				...
				if(index==2){
					currentSlide=2;
					$("#indicatorActive").animate({width:"40%"});
					$(".compare .new").resizable({
						minWidth:10,
						maxWidth:365,
						handles:{"w":"#wgrip"}	
					});
				...
				if(index==3){
					currentSlide=3;
					$("#indicatorActive").animate({width:"60%"});
				}	
				if(index==4){
					currentSlide=4;
					$("#indicatorActive").animate({width:"80%"});
				}	
				if(index==5){
					currentSlide=5;
	...
	$(".save").on("click",function(){
			...
			var absatz;
			switch(currentSlide){
				case 1: absatz="KONZEPT";
				break;
				case 2: absatz="WIREFRAMES";
				break;
				case 3: absatz="GESTALTUNG"; 
				break;
				case 4: absatz="PROTOTYP";
				break;
				case 5: absatz="FAZIT";
				break;	
			}
